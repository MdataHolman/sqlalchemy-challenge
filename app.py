...
def welcome():
    ...
    return (
        ...
        f"Here you can get the hyperlinked routes"
        f"<ol><li><a href=http://127.0.0.1:5000/api/v1.0/precipitation>"
        f"List of precipitation for the most recent year of data available</a></li><br/><br/>"
        f"<li><a href=http://127.0.0.1:5000/api/v1.0/stations>"
        f"List of weather stations</a></li><br/><br/>"
        f"<li><a href=http://127.0.0.1:5000/api/v1.0/tobs>"
        f"Daily Temperature Observations for Station USC00519281 for Last Year</a></li><br/><br/>"
        f"<li><a href=http://127.0.0.1:5000/api/v1.0/2017-08-23>"
        f"When given the start date (YYYY-MM-DD), calculates the min, avg, and max temp for all dates greater than and equal to the start date</a></li><br/><br/>"
        f"<li><a href=http://127.0.0.1:5000/api/v1.0/2016-08-23/2017-08-23>"
        f"When given the start and the end date (YYYY-MM-DD), calculate the min, avg, and max temp for dates between the start and end date</a></li></ol><br/>"
